...
#																																									#
#	File Name:				./targeted_functions/multiplier/ide.tcl																				#
#	Last Update:			01/12/2015																													#
#																																									#
###################################################################################
#	+	Input of ./targeted_functions/multiplier/ide.tcl:																							#
#	-	./targeted_functions/multiplier/verilogs/*.v																								#
#	-	./targeted_functions/template.dcp																											#
#	-	./targeted_functions/blank/impl.dcp																										#
###################################################################################
#	+	Output of ./targeted_functions/multiplier/ide.tcl:																						#
#	-	./targeted_functions/multiplier/synth.dcp																									#
#	-	./targeted_functions/multiplier/impl.dcp																									#
#	-	./targeted_functions/multiplier/bitstreams/blank_reconfigurable_partition_<00-15>_partial.bit						#
#	-	./sdcard/hwdll/library/multiplier/rm_<00-15>.bin																						#
###################################################################################
