...
#																																									#
#	File Name:				./targeted_functions/numbers/ide.tcl																				#
#	Last Update:			01/12/2015																													#
#																																									#
###################################################################################
#	+	Input of ./targeted_functions/numbers/ide.tcl:																							#
#	-	./targeted_functions/numbers/verilogs/*.v																								#
#	-	./targeted_functions/template.dcp																											#
#	-	./targeted_functions/blank/impl.dcp																										#
###################################################################################
#	+	Output of ./targeted_functions/numbers/ide.tcl:																						#
#	-	./targeted_functions/numbers/synth.dcp																									#
#	-	./targeted_functions/numbers/impl.dcp																									#
#	-	./targeted_functions/numbers/bitstreams/blank_reconfigurable_partition_<00-15>_partial.bit						#
#	-	./sdcard/hwdll/library/numbers/rm_<00-15>.bin																						#
###################################################################################
