...
#																																									#
#	File Name:				./targeted_functions/adder_subtractor/ide.tcl																	#
#	Last Update:			01/12/2015																													#
#																																									#
###################################################################################
#	+	Input of ./targeted_functions/adder_subtractor/ide.tcl:																				#
#	-	./targeted_functions/adder_subtractor/verilogs/*.v																					#
#	-	./targeted_functions/template.dcp																											#
#	-	./targeted_functions/blank/impl.dcp																										#
###################################################################################
#	+	Output of ./targeted_functions/adder_subtractor/ide.tcl:																			#
#	-	./targeted_functions/adder_subtractor/synth.dcp																						#
#	-	./targeted_functions/adder_subtractor/impl.dcp																						#
#	-	./targeted_functions/adder_subtractor/bitstreams/blank_reconfigurable_partition_<00-15>_partial.bit			#
#	-	./sdcard/hwdll/library/adder_subtractor/rm_<00-15>.bin																			#
###################################################################################
