...
#																																									#
#	File Name:				./targeted_functions/prime/ide.tcl																					#
#	Last Update:			01/12/2015																													#
#																																									#
###################################################################################
#	+	Input of ./targeted_functions/prime/ide.tcl:																								#
#	-	./targeted_functions/prime/verilogs/*.v																									#
#	-	./targeted_functions/template.dcp																											#
#	-	./targeted_functions/blank/impl.dcp																										#
###################################################################################
#	+	Output of ./targeted_functions/prime/ide.tcl:																							#
#	-	./targeted_functions/prime/synth.dcp																										#
#	-	./targeted_functions/prime/impl.dcp																										#
#	-	./targeted_functions/prime/bitstreams/blank_reconfigurable_partition_<00-15>_partial.bit							#
#	-	./sdcard/hwdll/library/prime/rm_<00-15>.bin																							#
###################################################################################
