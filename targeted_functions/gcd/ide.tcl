...
#																																									#
#	File Name:				./targeted_functions/gcd/ide.tcl																						#
#	Last Update:			01/12/2015																													#
#																																									#
###################################################################################
#	+	Input of ./targeted_functions/gcd/ide.tcl:																									#
#	-	./targeted_functions/gcd/verilogs/*.v																										#
#	-	./targeted_functions/template.dcp																											#
#	-	./targeted_functions/blank/impl.dcp																										#
###################################################################################
#	+	Output of ./targeted_functions/gcd/ide.tcl:																								#
#	-	./targeted_functions/gcd/synth.dcp																											#
#	-	./targeted_functions/gcd/impl.dcp																											#
#	-	./targeted_functions/gcd/bitstreams/blank_reconfigurable_partition_<00-15>_partial.bit								#
#	-	./sdcard/hwdll/library/gcd/rm_<00-15>.bin																								#
###################################################################################
