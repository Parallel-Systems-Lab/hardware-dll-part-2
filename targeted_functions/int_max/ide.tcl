...
#																																									#
#	File Name:				./targeted_functions/int_max/ide.tcl																					#
#	Last Update:			01/12/2015																													#
#																																									#
###################################################################################
#	+	Input of ./targeted_functions/int_max/ide.tcl:																							#
#	-	./targeted_functions/int_max/verilogs/*.v																									#
#	-	./targeted_functions/template.dcp																											#
#	-	./targeted_functions/blank/impl.dcp																										#
###################################################################################
#	+	Output of ./targeted_functions/int_max/ide.tcl:																							#
#	-	./targeted_functions/int_max/synth.dcp																									#
#	-	./targeted_functions/int_max/impl.dcp																										#
#	-	./targeted_functions/int_max/bitstreams/blank_reconfigurable_partition_<00-15>_partial.bit							#
#	-	./sdcard/hwdll/library/int_max/rm_<00-15>.bin																						#
###################################################################################
