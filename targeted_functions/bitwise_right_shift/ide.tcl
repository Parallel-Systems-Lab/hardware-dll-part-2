...
#																																									#
#	File Name:				./targeted_functions/bitwise_right_shift/ide.tcl																	#
#	Last Update:			01/12/2015																													#
#																																									#
###################################################################################
#	+	Input of ./targeted_functions/bitwise_right_shift/ide.tcl:																				#
#	-	./targeted_functions/bitwise_right_shift/verilogs/*.v																					#
#	-	./targeted_functions/template.dcp																											#
#	-	./targeted_functions/blank/impl.dcp																										#
###################################################################################
#	+	Output of ./targeted_functions/bitwise_right_shift/ide.tcl:																			#
#	-	./targeted_functions/bitwise_right_shift/synth.dcp																						#
#	-	./targeted_functions/bitwise_right_shift/impl.dcp																						#
#	-	./targeted_functions/bitwise_right_shift/bitstreams/blank_reconfigurable_partition_<00-15>_partial.bit			#
#	-	./sdcard/hwdll/library/bitwise_right_shift/rm_<00-15>.bin																			#
###################################################################################
