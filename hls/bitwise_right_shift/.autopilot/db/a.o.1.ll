; ModuleID = 'C:/xilinx/hls/bitwise_right_shift/.autopilot/db/a.g.1.bc'
...
define i32 @targeted_function(i32 %input_000, i32* %output_000) nounwind uwtable {
  ...
  %output_000.assign = ashr i32 %input_000, 1, !dbg !25 ; [#uses=1 type=i32] [debug line = 26:2]
  store i32 %output_000.assign, i32* %output_000, align 4, !dbg !25 ; [debug line = 26:2]
  ret i32 0, !dbg !26                             ; [debug line = 27:2]
}
...
!25 = metadata !{i32 26, i32 2, metadata !24, null}
!26 = metadata !{i32 27, i32 2, metadata !24, null}
