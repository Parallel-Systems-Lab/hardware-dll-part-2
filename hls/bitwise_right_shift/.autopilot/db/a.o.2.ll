...
define i32 @targeted_function(i32 %input_000, i32* %output_000) nounwind uwtable {
  ...
  %tmp = lshr i32 %input_000, 1, !dbg !37         ; [#uses=1 type=i32] [debug line = 26:2]
  %tmp.1 = trunc i32 %tmp to i31, !dbg !37        ; [#uses=1 type=i31] [debug line = 26:2]
  %output_000.assign = sext i31 %tmp.1 to i32, !dbg !37 ; [#uses=1 type=i32] [debug line = 26:2]
  store i32 %output_000.assign, i32* %output_000, align 4, !dbg !37 ; [debug line = 26:2]
  ret i32 0, !dbg !38                             ; [debug line = 27:2]
}
...
!0 = metadata !{i32 786449, i32 0, i32 1, metadata !"C:/xilinx/hls/bitwise_right_shift/.autopilot/db/targeted_function.pragma.2.c", metadata !"c:/xilinx", metadata !"clang version 3.1 ", i1 true, i1 false, metadata !"", i32 0, metadata !1, metadata !1, metadata !3, metadata !1} ; [ DW_TAG_compile_unit ]
...
!6 = metadata !{i32 786473, metadata !"./targeted_functions/bitwise_right_shift/targeted_function.c", metadata !"c:/xilinx", null} ; [ DW_TAG_file_type ]
...
!37 = metadata !{i32 26, i32 2, metadata !36, null}
!38 = metadata !{i32 27, i32 2, metadata !36, null}
