; ModuleID = 'C:/xilinx/hls/multiplier/.autopilot/db/a.g.1.bc'
...
define i32 @targeted_function(i32 %input_000, i32 %input_001, i32* %output_000) nounwind uwtable {
  ...
  %output_000.assign = mul nsw i32 %input_001, %input_000, !dbg !27 ; [#uses=1 type=i32] [debug line = 26:2]
  store i32 %output_000.assign, i32* %output_000, align 4, !dbg !27 ; [debug line = 26:2]
  ret i32 0, !dbg !28                             ; [debug line = 27:2]
}
...
!28 = metadata !{i32 27, i32 2, metadata !26, null}
