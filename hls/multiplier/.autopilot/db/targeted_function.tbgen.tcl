set C_TypeInfoList {{ 
"targeted_function" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"input_000": [[], {"scalar": "int"}] }, {"input_001": [[], {"scalar": "int"}] }, {"output_000": [[],{ "pointer":  {"scalar": "int"}}] }],[],""]
}}
