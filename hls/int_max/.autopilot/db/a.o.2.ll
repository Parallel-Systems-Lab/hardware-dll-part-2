; ModuleID = 'C:/xilinx/hls/int_max/.autopilot/db/a.o.2.bc'
...
@.str2 = private unnamed_addr constant [1 x i8] zeroinitializer, align 1 ; [#uses=6 type=[1 x i8]*]
@.str1 = private unnamed_addr constant [3 x i8] c"rm\00", align 1 ; [#uses=2 type=[3 x i8]*]
...
define i32 @targeted_function(i32* %output_000) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{i32* %output_000}, i64 0, metadata !25), !dbg !26 ; [debug line = 30:29] [debug variable = output_000]
  call void (...)* @_ssdm_op_SpecInterface(i32* %output_000, [10 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [3 x i8]* @.str1, [1 x i8]* @.str2, [1 x i8]* @.str2, [1 x i8]* @.str2) nounwind, !dbg !27 ; [debug line = 32:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [3 x i8]* @.str1, [1 x i8]* @.str2, [1 x i8]* @.str2, [1 x i8]* @.str2) nounwind, !dbg !27 ; [debug line = 32:1]
  store i32 2147483647, i32* %output_000, align 4, !dbg !29 ; [debug line = 32:2]
  ret i32 0, !dbg !30                             ; [debug line = 33:2]
}
...
!25 = metadata !{i32 786689, metadata !5, metadata !"output_000", metadata !6, i32 16777246, metadata !10, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!26 = metadata !{i32 30, i32 29, metadata !5, null}
!27 = metadata !{i32 32, i32 1, metadata !28, null}
!28 = metadata !{i32 786443, metadata !5, i32 31, i32 1, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
!29 = metadata !{i32 32, i32 2, metadata !28, null}
!30 = metadata !{i32 33, i32 2, metadata !28, null}
