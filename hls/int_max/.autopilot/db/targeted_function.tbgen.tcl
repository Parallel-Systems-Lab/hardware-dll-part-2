set C_TypeInfoList {{ 
"targeted_function" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"output_000": [[],{ "pointer":  {"scalar": "int"}}] }],[],""]
}}
...
set C_modelArgMapList {[ 
	{ "Name" : "output_000", "interface" : "axi_slave", "bundle":"rm","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "output_000","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":24}, "offset_end" : {"out":31}} , 
...
set NewPortList {[ 
	{ "name": "s_axi_rm_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "rm", "role": "AWADDR" },"address":[{"name":"targeted_function","role":"start","value":"0","valid_bit":"0"},{"name":"targeted_function","role":"continue","value":"0","valid_bit":"4"},{"name":"targeted_function","role":"auto_start","value":"0","valid_bit":"7"}] },
