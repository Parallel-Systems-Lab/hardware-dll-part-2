...
targeted_function::targeted_function(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( tmp_1_fu_71_p3 );
    sensitive << ( tmp_2_fu_79_p2 );
    ...
    SC_METHOD(thread_tmp_1_fu_71_p3);
    sensitive << ( tmp_fu_65_p2 );
    ...
    sc_trace(mVcdFile, tmp_1_fu_71_p3, "tmp_1_fu_71_p3");
...
void targeted_function::thread_output_000() {
    output_000 = (!input_001.read().is_01() || !input_000.read().is_01())? sc_lv<32>(): (sc_biguint<32>(input_001.read()) + sc_biguint<32>(input_000.read()));
}
...
void targeted_function::thread_output_001() {
    output_001 = (!tmp_1_fu_71_p3.read()[0].is_01())? sc_lv<32>(): ((tmp_1_fu_71_p3.read()[0].to_bool())? tmp_2_fu_79_p2.read(): tmp_fu_65_p2.read());
}
...
void targeted_function::thread_tmp_1_fu_71_p3() {
    tmp_1_fu_71_p3 = tmp_fu_65_p2.read().range(31, 31);
}

void targeted_function::thread_tmp_2_fu_79_p2() {
    tmp_2_fu_79_p2 = (!input_001.read().is_01() || !input_000.read().is_01())? sc_lv<32>(): (sc_biguint<32>(input_001.read()) - sc_biguint<32>(input_000.read()));
}

void targeted_function::thread_tmp_fu_65_p2() {
    tmp_fu_65_p2 = (!input_000.read().is_01() || !input_001.read().is_01())? sc_lv<32>(): (sc_biguint<32>(input_000.read()) - sc_biguint<32>(input_001.read()));
}
