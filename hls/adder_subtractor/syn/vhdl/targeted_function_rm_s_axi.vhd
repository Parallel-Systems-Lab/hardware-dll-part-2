...
architecture behave of targeted_function_rm_s_axi is
    ...
    constant ADDR_INPUT_000_DATA_0  : INTEGER := 16#18#;
    constant ADDR_INPUT_000_CTRL    : INTEGER := 16#1c#;
    constant ADDR_INPUT_001_DATA_0  : INTEGER := 16#20#;
    constant ADDR_INPUT_001_CTRL    : INTEGER := 16#24#;
    constant ADDR_OUTPUT_000_DATA_0 : INTEGER := 16#28#;
    constant ADDR_OUTPUT_000_CTRL   : INTEGER := 16#2c#;
    constant ADDR_OUTPUT_001_DATA_0 : INTEGER := 16#30#;
    constant ADDR_OUTPUT_001_CTRL   : INTEGER := 16#34#;
    ...
    signal int_input_000       : UNSIGNED(31 downto 0);
    signal int_input_001       : UNSIGNED(31 downto 0);
    ...
    begin
        if (ACLK'event and ACLK = '1') and ACLK_EN = '1' then
            if (ar_hs = '1') then
                ...
                when ADDR_INPUT_000_DATA_0 =>
                    rdata_data <= RESIZE(int_input_000(31 downto 0), 32);
                when ADDR_INPUT_001_DATA_0 =>
                    rdata_data <= RESIZE(int_input_001(31 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    input_000            <= STD_LOGIC_VECTOR(int_input_000);
    input_001            <= STD_LOGIC_VECTOR(int_input_001);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_INPUT_000_DATA_0) then
                    int_input_000(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_input_000(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_INPUT_001_DATA_0) then
                    int_input_001(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_input_001(31 downto 0));
                end if;
            end if;
        end if;
    end process;
