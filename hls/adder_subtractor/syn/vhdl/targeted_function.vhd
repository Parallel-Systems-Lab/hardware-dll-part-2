...
architecture behav of targeted_function is 
    ...
    "targeted_function,hls_ip_2015_4,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.810000,HLS_SYN_LAT=0,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=220,HLS_SYN_LUT=488}";
    ...
    signal tmp_fu_65_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_1_fu_71_p3 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    output_000 <= std_logic_vector(unsigned(input_001) + unsigned(input_000));
    ...
    output_001 <= 
        tmp_2_fu_79_p2 when (tmp_1_fu_71_p3(0) = '1') else 
        tmp_fu_65_p2;
    ...
    tmp_1_fu_71_p3 <= tmp_fu_65_p2(31 downto 31);
    tmp_2_fu_79_p2 <= std_logic_vector(unsigned(input_001) - unsigned(input_000));
    tmp_fu_65_p2 <= std_logic_vector(unsigned(input_000) - unsigned(input_001));
end behav;
