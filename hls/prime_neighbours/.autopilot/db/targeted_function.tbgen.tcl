set C_TypeInfoList {{ 
"targeted_function" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"input_000": [[], {"scalar": "int"}] }, {"output_000": [[],{ "pointer":  {"scalar": "int"}}] }, {"output_001": [[],{ "pointer":  {"scalar": "int"}}] }],[],""]
}}
...
set C_modelArgMapList {[ 
	{ "Name" : "input_000", "interface" : "axi_slave", "bundle":"rm","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "input_000","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	...
 	{ "Name" : "output_001", "interface" : "axi_slave", "bundle":"rm","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "output_001","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}], "offset" : {"out":40}, "offset_end" : {"out":47}} , 
